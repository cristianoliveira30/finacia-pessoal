...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_businesscriticities', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('businesscriticities_id')->default(0);
            ...
            $table->unique(['businesscriticities_id', 'name'], 'unicity');
        });
    }
    ...
    {
        Schema::dropIfExists('glpi_businesscriticities');
    }
};
