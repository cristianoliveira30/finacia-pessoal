...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_cartridgeitems', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('cartridgeitemtypes_id')->default(0)->index('cartridgeitemtypes_id');
    ...
    {
        Schema::dropIfExists('glpi_cartridgeitems');
    }
};
