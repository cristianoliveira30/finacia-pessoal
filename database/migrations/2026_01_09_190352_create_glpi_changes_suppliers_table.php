...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_changes_suppliers', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unique(['changes_id', 'type', 'suppliers_id'], 'unicity');
        });
    }
    ...
    {
        Schema::dropIfExists('glpi_changes_suppliers');
    }
};
