...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_devicemotherboards', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('devicemotherboardmodels_id')->nullable()->index('devicemotherboardmodels_id');
    ...
    {
        Schema::dropIfExists('glpi_devicemotherboards');
    }
};
