...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_items_devicebatteries', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('items_id')->default(0);
            $table->string('itemtype', 255)->nullable();
            $table->unsignedInteger('devicebatteries_id')->default(0)->index('devicebatteries_id');
            ...
            $table->integer('real_capacity')->default(0);
    ...
    {
        Schema::dropIfExists('glpi_items_devicebatteries');
    }
};
