...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_items_devicegenerics', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('items_id')->default(0);
            $table->string('itemtype', 255)->nullable();
            $table->unsignedInteger('devicegenerics_id')->default(0)->index('devicegenerics_id');
    ...
    {
        Schema::dropIfExists('glpi_items_devicegenerics');
    }
};
