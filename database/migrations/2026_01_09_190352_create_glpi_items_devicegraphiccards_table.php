...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_items_devicegraphiccards', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('items_id')->default(0);
            $table->string('itemtype', 255)->nullable();
            $table->unsignedInteger('devicegraphiccards_id')->default(0)->index('devicegraphiccards_id');
            $table->integer('memory')->default(0)->index('specificity');
    ...
    {
        Schema::dropIfExists('glpi_items_devicegraphiccards');
    }
};
