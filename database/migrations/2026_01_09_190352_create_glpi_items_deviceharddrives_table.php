...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_items_deviceharddrives', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('items_id')->default(0);
            $table->string('itemtype', 255)->nullable();
            $table->unsignedInteger('deviceharddrives_id')->default(0)->index('deviceharddrives_id');
            $table->integer('capacity')->default(0)->index('specificity');
    ...
    {
        Schema::dropIfExists('glpi_items_deviceharddrives');
    }
};
