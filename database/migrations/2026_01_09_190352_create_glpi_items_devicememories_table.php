...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_items_devicememories', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('items_id')->default(0);
            $table->string('itemtype', 255)->nullable();
            $table->unsignedInteger('devicememories_id')->default(0)->index('devicememories_id');
            $table->integer('size')->default(0)->index('specificity');
    ...
    {
        Schema::dropIfExists('glpi_items_devicememories');
    }
};
