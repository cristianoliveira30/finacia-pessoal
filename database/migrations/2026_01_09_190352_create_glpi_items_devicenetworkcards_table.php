...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_items_devicenetworkcards', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('items_id')->default(0);
            $table->string('itemtype', 255)->nullable();
            $table->unsignedInteger('devicenetworkcards_id')->default(0)->index('devicenetworkcards_id');
            $table->string('mac', 255)->nullable()->index('specificity');
    ...
    {
        Schema::dropIfExists('glpi_items_devicenetworkcards');
    }
};
