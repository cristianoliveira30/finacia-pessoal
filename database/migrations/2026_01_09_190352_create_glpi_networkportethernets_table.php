...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_networkportethernets', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('type', 10)->nullable()->default('')->index('type')->comment('T, LX, SX');
    ...
    {
        Schema::dropIfExists('glpi_networkportethernets');
    }
};
