...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_passivedcequipmentmodels', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->tinyInteger('is_half_rack')->default(0);
    ...
    {
        Schema::dropIfExists('glpi_passivedcequipmentmodels');
    }
};
