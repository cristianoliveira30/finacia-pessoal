...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_peripherals', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('peripheraltypes_id')->default(0)->index('peripheraltypes_id');
            $table->unsignedInteger('peripheralmodels_id')->default(0)->index('peripheralmodels_id');
    ...
    {
        Schema::dropIfExists('glpi_peripherals');
    }
};
