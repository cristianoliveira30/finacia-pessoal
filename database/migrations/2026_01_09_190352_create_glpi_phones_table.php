...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_phones', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('phonetypes_id')->default(0)->index('phonetypes_id');
            $table->unsignedInteger('phonemodels_id')->default(0)->index('phonemodels_id');
            $table->string('brand', 255)->nullable();
            $table->unsignedInteger('phonepowersupplies_id')->default(0)->index('phonepowersupplies_id');
            $table->string('number_line', 255)->nullable();
            $table->boolean('have_headset')->default(false);
            $table->boolean('have_hp')->default(false);
    ...
    {
        Schema::dropIfExists('glpi_phones');
    }
};
