...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_plugin_glpiinventory_deploypackages_groups', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('glpi_plugin_glpiinventory_deploypackages_groups');
    }
};
