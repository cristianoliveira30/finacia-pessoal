...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_problems_users', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unique(['problems_id', 'type', 'users_id', 'alternative_email'], 'unicity');
    ...
    {
        Schema::dropIfExists('glpi_problems_users');
    }
};
