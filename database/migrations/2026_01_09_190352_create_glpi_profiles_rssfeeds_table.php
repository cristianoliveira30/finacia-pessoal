...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_profiles_rssfeeds', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('rssfeeds_id')->default(0)->index('rssfeeds_id');
    ...
    {
        Schema::dropIfExists('glpi_profiles_rssfeeds');
    }
};
