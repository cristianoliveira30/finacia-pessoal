...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_rulematchedlogs', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamp('date')->nullable();
            $table->unsignedInteger('items_id')->default(0);
            $table->string('itemtype', 100)->nullable();
            $table->unsignedInteger('rules_id')->nullable()->index('rules_id');
    ...
    {
        Schema::dropIfExists('glpi_rulematchedlogs');
    }
};
