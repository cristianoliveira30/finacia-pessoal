...
return new class extends Migration
{
    ...
    {
        Schema::create('glpi_suppliers_tickets', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unique(['tickets_id', 'type', 'suppliers_id'], 'unicity');
        });
    }
    ...
    {
        Schema::dropIfExists('glpi_suppliers_tickets');
    }
};
