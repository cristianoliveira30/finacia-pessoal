        ...
        <div class="w-full max-w-7xl">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between mb-4 gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">Visualize, busque e edite as ações cadastradas.</p>
                </div>
                ...
                <div class="flex w-full md:w-auto gap-2">
                    ...
                    <a href="{{ route('acoes/cadastro') }}" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 flex items-center gap-2">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-00 dark:text-gray-400">
                        <tr>
