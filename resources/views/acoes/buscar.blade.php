<x-layouts.app :title="__('Gerenciar Ações')">
    <div class="pt-4 px-3 sm:px-6 lg:pl-16 space-y-4 flex flex-col items-center justify-start w-full min-h-screen p-6 transition-colors duration-300">
        ...
        <div class="w-full max-w-7xl">
            ...
            <div class="flex flex-col gap-4 mb-6">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white">Gerenciar Ações</h2>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Visualize e edite as ações cadastradas.</p>
                    </div>
                    
                    <a href="{{ route('acoes/cadastro') }}" class="text-gray-600 bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-gray-500/50 dark:hover:text-white focus:outline-2 focus:outline-offset-2 dark:focus:ring-primary-800 flex items-center gap-2 shadow-sm transition-colors">
                ...
                {{-- CARD DE PESQUISA E FILTROS --}}
                    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-3 dark:bg-gray-800 transition-colors duration-300">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white">Pesquisar Ações</h3>
                    </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase dark:bg-gray-800 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-3 py-3">Nome da Ação</th>
                            <th scope="col" class="px-3 py-3">Início</th>
                            <th scope="col" class="px-3 py-3">Fim</th>
                            <th scope="col" class="px-3 py-3">Status</th>
                            <th scope="col" class="px-3 py-3">Ações</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input id="table-checkbox-acoes" type="checkbox" value="" class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-900 dark:border-gray-600">
                                </div>
                            </td>
                            ...
                            <td class="px-3 py-4 flex gap-2">
                                <button type="button" data-modal-target="editAcaoModal" data-modal-toggle="editAcaoModal" class="font-medium text-primary-600 dark:text-blue-400 hover:underline">
                                    Editar
                                </button>
        ...
        {{-- MODAL DE EDIÇÃO --}}
        <div id="editAcaoModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full backdrop-blur-sm bg-gray-800/50">
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                <div class="relative p-4 bg-white rounded-xl shadow-lg dark:bg-gray-800 sm:p-5 border border-slate-200 dark:border-slate-700">
                    <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="editAcaoModal">
                    ...
                    <form action="#">
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="name" id="name" value="Reunião de Pauta" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                            </div>
    ...
    <script>
        // Dados de exemplo para o módulo de ações
        window.viewData = [
            {
                'Nome': 'Reunião de Pauta',
                'Início': '14/12/2025 14:00',
                'Fim': '14/12/2025 16:00',
                'Status': 'Agendado'
            }
        ];
    </script>
