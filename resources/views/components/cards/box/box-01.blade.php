        ...
        <div class="relative z-10 flex justify-between h-full">
            ...
            <div class="flex flex-col justify-between">
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        {{-- Exibe Trend se não estiver escondida --}}
                        @unless($hideTrend)
            ...
            <div class="flex flex-col justify-between items-end pl-4">
                ...
                <div class="p-2.5 rounded-xl border shadow-sm transition-colors
                    ...
                    {{-- AQUI ESTÁ A LÓGICA DO ÍCONE --}}
                    @if(isset($config['icon']))
                        {!! $config['icon'] !!}  {{-- Renderiza o SVG passado no array --}}
                    @else
                        {{-- Ícone Padrão se não vier nada --}}
                        <x-bi-clipboard2-pulse class="w-6 h-6"/>
                    @endif
                </div>
