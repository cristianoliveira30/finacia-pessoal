...
@php
    $definitions = [
        ...
        'gestao' => [
            ...
            'bg_class' => 'bg-amber-100 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400 black:bg-amber-900/20 black:text-amber-400', 
        ...
        'financas' => [
            ...
            'bg_class' => 'bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300 black:bg-zinc-800 black:text-zinc-300', 
        ...
        'pendencias' => [
            ...
            'bg_class' => 'bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 black:bg-red-900/20 black:text-red-400',
        ...
        <div class="relative w-full min-w-[200px] overflow-hidden h-full
            ...
            <div class="relative z-10 flex justify-between h-full">
                ...
                <div class="flex flex-col justify-between items-end pl-4">
                    ...
                    <a href="{{ $card['link'] }}" class="group/link relative p-1.5 rounded-lg text-slate-400 hover:text-sky-600 hover:bg-slate-200 dark:hover:bg-slate-700 black:hover:bg-zinc-800 transition-colors">
