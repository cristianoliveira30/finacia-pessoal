...
<div id="{{ $id }}" data-accordion="collapse"
    ...
    <div class="relative z-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 p-3">
            ...
            {{-- Título --}}
            {{-- ADICIONADO: text-center md:text-left para centralizar no mobile --}}
            <div class="space-y-2 text-center md:text-left w-full md:w-auto">
                {{-- SUAVIZADO: font-bold -> font-semibold | text-slate-900 -> text-slate-800 --}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="{{ $id }}-end-date" placeholder="dd / mm / aaaa" class="bg-white border border-slate-300 text-slate-700 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full ps-10 p-2.5 dark:bg-slate-800 dark:border-slate-600 dark:placeholder-slate-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500">
                            </div>
                        </div>
                    </div>
                ...
                <form id="{{ $id }}-ai-form" action="{{ route('ai.analise') }}" method="POST" class="space-y-4"
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="{{ $id }}-ai-prompt" name="prompt" rows="2" required
                            class="block p-2.5 w-full text-sm text-slate-700 bg-white rounded-lg border border-slate-300 focus:ring-sky-600 focus:border-sky-600 resize-none dark:bg-slate-800 dark:border-slate-600 dark:placeholder-slate-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500"
                            placeholder="Digite sua pergunta aqui..."></textarea>
                    </div>
                    <div class="space-y-2">
                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400">Resposta da IA</label>
