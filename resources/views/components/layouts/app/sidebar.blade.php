<aside id="top-bar-sidebar"
    class="fixed lg:sticky top-0 left-0 z-40 w-64 h-screen transition-all duration-300 -translate-x-full lg:translate-x-0 bg-neutral-primary-soft dark:bg-slate-900 border-e border-default"
    aria-label="Sidebar">
