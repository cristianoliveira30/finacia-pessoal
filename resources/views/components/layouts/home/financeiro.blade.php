...
@php
    $menus = [
        ...
        [
            ...
            'items' => [
                [
                    'label' => 'LOA (Dotação Inicial)',
                    'route' => 'financeiro.orcamento.loa',
                    'icon' => 'file-earmark-text',
                ],
                [
                    'label' => 'PPA / Programas e Ações',
                    'route' => 'financeiro.orcamento.ppa',
                    'icon' => 'file-earmark-text',
                ],
                [
                    'label' => 'LDO / Metas e Prioridades',
                    'route' => 'financeiro.orcamento.ldo',
                    'icon' => 'file-earmark-text',
                ],
                [
                    'label' => 'Alterações (Créditos Adicionais)',
                    'route' => 'financeiro.orcamento.creditos',
        ...
        [
            ...
            'items' => [
                [
                    'label' => 'Arrecadação (Real x Previsto)',
                    'route' => 'financeiro.receitas.arrecadacao',
                    'icon' => 'graph-up',
                ],
                [
                    'label' => 'Receita por Fonte (Própria/Transf.)',
                    'route' => 'financeiro.receitas.fontes',
                    'icon' => 'pie-chart',
                ],
                [
                    'label' => 'Transferências (FPM/ICMS/SUS/FUNDEB)',
                    'route' => 'financeiro.receitas.transferencias',
                    'icon' => 'bank',
                ],
                [
        ...
        [
            ...
            'items' => [
                ...
                [
                    'label' => 'Emendas / Convênios',
                    'route' => 'financeiro.investimentos.convenios',
                    'icon' => 'file-earmark-text',
                ],
                [
                    'label' => 'Cronograma Físico-Financeiro',
                    'route' => 'financeiro.investimentos.cronograma',
                    'icon' => 'calendar3',
                ],
                [
                    'label' => 'Contrapartidas',
                    'route' => 'financeiro.investimentos.contrapartidas',
                    'icon' => 'arrow-left-right',
                ],
            ],
        ],
        ...
        [
            ...
            'items' => [
                ...
                [
                    'label' => 'Fluxo de Caixa (D+30/D+90)',
                    'route' => 'financeiro.tesouraria.fluxo',
                    'icon' => 'graph-up',
                ],
                [
                    'label' => 'Conciliação Bancária',
                    'route' => 'financeiro.tesouraria.conciliacao',
                    'icon' => 'arrow-left-right',
                ],
                [
                    'label' => 'Aplicações / Rendimentos',
                    'route' => 'financeiro.tesouraria.aplicacoes',
                    'icon' => 'coin',
                ],
            ],
        ],
...
<aside id="top-bar-sidebar"
    ...
    @foreach ($menus as $menu)
        {{-- Popover Container: black:bg-zinc-900 black:border-zinc-800 --}}
