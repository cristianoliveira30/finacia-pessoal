...
$menus = [
    ...
    [
        ...
        'items' => [
            ...
            ['label' => 'Produção por Unidade', 'route' => 'saude.relatorios.producao_unidade', 'icon' => 'building'],
            ['label' => 'Produção por Profissional', 'route' => 'saude.relatorios.producao_profissional', 'icon' => 'person-badge'],
            ['label' => 'Absenteísmo (No-show)', 'route' => 'saude.relatorios.no_show', 'icon' => 'calendar-x'],
            ['label' => 'Encaminhamentos / Regulação', 'route' => 'saude.relatorios.regulacao', 'icon' => 'arrow-left-right'],
            ['label' => 'Indicadores SUS (Resumo)', 'route' => 'saude.relatorios.indicadores_sus', 'icon' => 'graph-up'],
        ],
    ],
    ...
    [
        ...
        'items' => [
            ...
            ['label' => 'Classificação de Risco', 'route' => 'saude.urgencia.classificacao', 'icon' => 'exclamation-triangle'],
            ['label' => 'Tempo Porta-Médico', 'route' => 'saude.urgencia.porta_medico', 'icon' => 'stopwatch'],
            ['label' => 'Leitos (Disponibilidade)', 'route' => 'saude.urgencia.leitos', 'icon' => 'clipboard2-pulse'],
        ],
    ],
    ...
    [
        ...
        'items' => [
            ['label' => 'Notificações (SINAN)', 'route' => 'saude.vigilancia.notificacoes', 'icon' => 'clipboard-data'],
            ...
            ['label' => 'Indicadores Epidemiológicos', 'route' => 'saude.vigilancia.indicadores', 'icon' => 'activity'],
        ],
    ],
    ...
    [
        ...
        'items' => [
            ...
            ['label' => 'Perdas / Vencimentos', 'route' => 'saude.imunizacao.perdas', 'icon' => 'exclamation-triangle'],
        ],
    ],
    ...
    [
        ...
        'items' => [
            ['label' => 'Disponibilidade de Itens', 'route' => 'saude.farmacia.disponibilidade', 'icon' => 'check2-circle'],
    ...
    [
        ...
        'items' => [
            ...
            ['label' => 'Mínimo Constitucional (15%)', 'route' => 'saude.financeiro.minimo', 'icon' => 'shield-check'],
