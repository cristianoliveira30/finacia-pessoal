...
<x-layouts.app :title="__('Enviar Notificação')">
    ...
    <div class="min-h-[calc(100vh-4rem)] pt-20 bg-slate-50 dark:bg-slate-950">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">

            {{-- PAGE HEADER (sem botões de voltar/cancelar) --}}
            <header class="mb-6">
                <p class="text-xs font-semibold tracking-wide text-slate-500 dark:text-slate-400">
            ...
            <div id="notifications-send-page"
                ...
                @php
                    ...
                    $setorColors = [
                        ...
                        'Saúde' => 'bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-200',
                        'Obras' => 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-200',
                ...
                <form id="send-notification-form" method="POST" action="#">
                    ...
                    <div class="p-6 sm:p-8 space-y-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2" id="notif-destino-group">
                                        ...
                                        <label class="cursor-pointer">
                                            <input class="sr-only peer" type="radio" name="destino" value="todos" checked>
                                            <div
                                ...
                                <div id="notif-setores-wrap" class="hidden md:col-span-2">
                                    ...
                                    <div class="relative">
                                        <button type="button" id="notif-setores-btn"
                                            ...
                                            <span id="notif-setores-label" class="truncate">Selecione um ou mais setores…</span>
                                        ...
                                        <div id="notif-setores-menu"
                                            ...
                                            <div class="flex items-center justify-between gap-2 p-2 border-t border-slate-200 dark:border-slate-700">
                        ...
                        <section>
                            <div class="flex items-center gap-2 mb-3">
                                <x-bi-pencil-square class="w-4 h-4 text-slate-600 dark:text-slate-300" />
                                <h2 class="text-sm font-bold text-slate-900 dark:text-slate-100">
                                    Conteúdo
                                </h2>
                            </div>
                                    ...
                                    <div id="notif-flag-editor"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
                                            ...
                                            <div class="md:col-span-2">
                                                <label class="block text-xs font-semibold text-slate-700 dark:text-slate-200 mb-1">
                                                    Texto da flag
                                                    <span class="text-[11px] font-normal text-slate-500 dark:text-slate-400">(opcional)</span>
                                                </label>
                    ...
                    <div class="sticky bottom-0 z-10 border-t border-slate-200 dark:border-slate-800
