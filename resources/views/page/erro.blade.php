...
<body
    class="min-h-screen h-full flex items-center justify-center px-4
    ...
    <div
        ...
        <div
            class="inline-flex items-center justify-center
                    ...
                    border border-red-200 dark:border-red-700 mb-6">
            <svg class="w-10 h-10 text-red-500 dark:text-red-400" xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        @isset($status)
            <p class="text-sm md:text-base text-slate-500 dark:text-slate-400 mb-2">
                Código do erro:
                <span class="font-mono font-semibold">{{ $status }}</span>
            </p>
        @endisset

        <p class="text-base md:text-lg text-slate-600 dark:text-slate-300 mb-10">
            Já registramos esse problema ou ele será analisado pela equipe.
            Você pode tentar voltar para a página anterior.
        </p>

        <button type="button" onclick="window.history.back()"
            class="inline-flex items-center justify-center gap-3 px-7 py-3.5
